            ...
            <div className="max-w-[1200px] mx-auto w-full px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="font-bold text-xl tracking-tight text-slate-900 dark:text-white">猪你好运</div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <button className="p-2 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-white rounded-full transition-colors" title="设置">
                            <span className="material-symbols-outlined text-xl">settings</span>
                        </button>
                        <div
                            className="bg-primary/20 rounded-full w-8 h-8 shrink-0 flex items-center justify-center text-lg cursor-pointer ring-2 ring-primary/10"
                            title="个人主页"
                        >
                            🐷
                        </div>
